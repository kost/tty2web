...
type Options struct {
	...
	FileServe           string           `hcl:"files" flagName:"files" flagDescribe:"Serve files to download from specified dir" default:""`
	FileUpload          bool             `hcl:"upload" flagName:"upload" flagDescribe:"Enable uploading of files to the tty2web host (BE CAREFUL!)" default:"false"`
